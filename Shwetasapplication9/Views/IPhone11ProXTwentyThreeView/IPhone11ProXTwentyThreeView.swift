            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack(alignment: .trailing, spacing: 0) {
                        VStack(alignment: .leading, spacing: 0) {
                            Group {
                                Text(StringConstants.kMsgClubsCourse)
                                    .font(FontScheme
                                    ...
                                    .padding(.trailing)
                                    .onTapGesture {
                                        iPhone11ProXTwentyThreeViewModel
                                ...
                                Text(StringConstants.kMsgWeHopeToProv)
                                    .font(FontScheme
                                        .kMontserratMedium(size: getRelativeHeight(12.0)))
                                    .fontWeight(.medium)
                                    ...
                                    .frame(width: getRelativeWidth(283.0),
                                           height: getRelativeHeight(163.0), alignment: .topLeading)
                                    .padding(.top, getRelativeHeight(26.0))
                                    .padding(.trailing, getRelativeWidth(10.0))
                                HStack {
                                    Text(StringConstants.kMsgMeetingDays)
                                        .font(FontScheme
                                        ...
                                        .frame(width: getRelativeWidth(145.0),
                                               ...
                                               alignment: .topLeading)
                                    Spacer()
                                    Text(StringConstants.kMsgMeetingTime)
                                        .font(FontScheme
                                            .kMontserratSemiBold(size: getRelativeHeight(14.0)))
                                        .fontWeight(.semibold)
                                        .foregroundColor(ColorConstants.Lime900)
                                ...
                                .padding(.trailing, getRelativeWidth(10.0))
                                VStack {
                                    Text(StringConstants.kMsgClubPresident)
                                        .font(FontScheme
                                            .kMontserratSemiBold(size: getRelativeHeight(14.0)))
                                        .fontWeight(.semibold)
                                        .foregroundColor(ColorConstants.Lime900)
                                ...
                                .clipShape(Capsule())
                                .padding(.trailing, getRelativeWidth(10.0))
                                Text(StringConstants.kMsgClubTeacherNa)
                                    .font(FontScheme
                                    ...
                                    ZStack(alignment: .trailing) {
                                        VStack {
                                            ...
                                            .background(RoundedCorners(topLeft: 12.0,
                                                                       ...
                                                                       bottomLeft: 12.0,
                                                                       bottomRight: 12.0))
                                            .shadow(color: ColorConstants.Black90033, radius: 6,
                                                    x: 0, y: 2)
                                        }
                                        .frame(width: getRelativeWidth(152.0),
                                               height: getRelativeHeight(120.0),
                        ...
                        .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(690.0),
                               alignment: .trailing)
                        .background(ColorConstants.WhiteA700)
                    }
                    .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(690.0),
                ...
                Group {
                    NavigationLink(destination: IPhone11ProXSixteenView(),
                                   ...
                                   selection: $iPhone11ProXTwentyThreeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct IPhone11ProXTwentyThreeView_Previews: PreviewProvider {
