                ...
                VStack {
                    ...
                    VStack {
                        ZStack(alignment: .leading) {
                            Button(action: {
                                iPhone11ProXFourViewModel.nextScreen = "IPhone11ProXSixOneContainerView"
                            }, label: {
                                HStack(spacing: 0) {
                                    ...
                                    NavigationLink(destination: IPhone11ProXSixOneContainerView(),
                                                   tag: "IPhone11ProXSixOneContainerView",
                                                   selection: $iPhone11ProXFourViewModel.nextScreen,
                                                   label: {
                                                       EmptyView()
                                                   })
                                }
