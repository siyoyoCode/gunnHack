...
class IPhone11ProXFourteenViewModel: ObservableObject {
    @Published var nextScreen: String? = nil
    @Published var searchbar: String = ""
    @Published var groupthirtyonePicker1: String = "Option 1"
    @Published var groupthirtyonePicker1Values: [String] = ["Option 1", "Option 2", "Option 3"]
