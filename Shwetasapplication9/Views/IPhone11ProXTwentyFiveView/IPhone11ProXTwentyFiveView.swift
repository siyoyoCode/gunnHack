...
struct IPhone11ProXTwentyFiveView: View {
    @StateObject var iPhone11ProXTwentyFiveViewModel = IPhone11ProXTwentyFiveViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack(alignment: .trailing, spacing: 0) {
                        VStack(alignment: .leading, spacing: 0) {
                            Text(StringConstants.kMsgClubsCourse2)
                                ...
                                .padding(.trailing)
                                .onTapGesture {
                                    iPhone11ProXTwentyFiveViewModel
                            ...
                            HStack {
                                Image("img_rectangle23_50x50")
                                    ...
                                    .scaledToFit()
                                    .clipped()
                                Text(StringConstants.kMsgComputingInf)
                                    .font(FontScheme
                            ...
                            Text(StringConstants.kMsgTheComputingA)
                                .font(FontScheme.kMontserratMedium(size: getRelativeHeight(12.0)))
                                .fontWeight(.medium)
                                .foregroundColor(ColorConstants.Lime900)
                                .minimumScaleFactor(0.5)
                            ...
                            HStack {
                                Image("img_vector_20x20")
                                    ...
                                    .scaledToFit()
                                    .clipped()
                                Text(StringConstants.kMsgMembershipFee2)
                                    .font(FontScheme
                            ...
                            .frame(width: getRelativeWidth(195.0), height: getRelativeHeight(20.0),
                                   alignment: .leading)
                            .clipShape(Capsule())
                            ...
                            .frame(width: getRelativeWidth(90.0), height: getRelativeHeight(33.0),
                                   alignment: .leading)
                            .padding(.top, getRelativeHeight(39.0))
                            .padding(.horizontal, getRelativeWidth(99.0))
                        }
                        .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(659.0),
                               alignment: .trailing)
                        .background(ColorConstants.WhiteA700)
                    }
                    .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(659.0),
                ...
                Group {
                    NavigationLink(destination: IPhone11ProXTwentySixView(),
                                   ...
                                   selection: $iPhone11ProXTwentyFiveViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct IPhone11ProXTwentyFiveView_Previews: PreviewProvider {
    static var previews: some View {
        IPhone11ProXTwentyFiveView()
    }
}
